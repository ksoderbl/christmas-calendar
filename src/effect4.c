...
#if 0
static void effect4_idle_cb(void)
{

}
#endif

static void effect4_keyboard_cb(unsigned char key, int x, int y)
{
	x=x;y=y;
	switch (key) {
	case ' ':
 ...
 */
void effect4_special_cb(int key, int x, int y)
{
	x=x;y=y;
	switch (key) {
...
int effect4_register(struct effect *ep)
{
	...
	ep->e_special  = effect4_special_cb;
